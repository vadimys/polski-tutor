...
class Settings(BaseSettings):
    ...
    # Централізований канал інфра-алертів: ОКРЕМИЙ бот + приватний канал (не продукт-бот!).
    # Порожні → фолбек на DM адміну через продукт-бота. Юзерам алерти НЕ йдуть у жодному разі.
    alert_bot_token: str = ""
    alert_chat_id: str = ""
