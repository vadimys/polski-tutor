...
_ZAD3 = MatchTask(
    ...
    explain=[
        "«a przecież ___» → F (у сучасному світі час — це гроші).",
        "«dzięki której ___» → D (просто і швидко).",
        "«całodobowo, więc ___» → A (навіть посеред ночі можеш бронювати).",
        "«Dzień przed ___» → G (отримаєш SMS-нагадування).",
        "«możesz także ___» → B (скасувати візит або змінити термін).",
        "«Aby korzystać, ___» → E (варто створити акаунт).",
        "«obowiązkowa, ___» → C (щоб записатися до фахівця)."],
)
...
_ZAD4 = MatchTask(
    ...
    explain=[
        "ремонтуй, не викидай → E (віддай телефон у сервіс).",
        "купуй менше й розумніше → G (подумай, перш ніж купити гаджет).",
        "дискутуй і навчай → A (розмовляй про екологію).",
        "багаторазовий → C (відмовся від одноразового).",
        "сортуй відходи → F (40% не сортують).",
        "прибираймо → B (піднось сміття з вулиці).",
        "зміни мислення про транспорт → D (велосипед, громадський транспорт)."],
)
