...
_ZAD3 = MatchTask(
    ...
    explain=[
        ...
        "«w którym ___» → D (випробовують можливості роботи).",
        "«Przeanalizujemy, ___» → B (як люди відреагують).",
        "«nie tylko zadowolenie, ___» → E (але й здоров'я досліджуваних).",
        "«pokazały, ___ było korzystne» → C (що скорочення тижня).",
        "«spowodowało, ___» → F (що мали більше охоти).",
        "«nic nowego, ___» → G (бо раніше в багатьох місцях)."],
)
...
_ZAD4 = MatchTask(
    ...
    explain=[
        "мало місця, багато сердечності → F (найменша кав'ярня, подружжя з України).",
        "технологія і кухня → D (замовляєш піцу через планшет).",
        "кінозал у ресторані → A (Jack's — фільм у авто-кріслах).",
        "вечеря в темряві → G (Dine in — майже нема світла).",
        "приготуй сам → B (Shabu-shabu — казанок на столі).",
        "тут склянки завжди повні → C (The Alchemist — стіна з кранами).",
        "у нетиповому товаристві й без м'яса → E (M. Cafe — коти, вегетаріанське)."],
)
