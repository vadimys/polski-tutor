...
_ZAD3 = MatchTask(
    ...
    explain=[
        "«wynosi ___» → D (менш ніж 10 м²).",
        "«układ ___» → B (найважливіших приладів).",
        "«odległość to ___» → F (від 1,5 до 2,5 м).",
        "«strefy: ___» → A (нарізання, миття, готування, випікання).",
        "«nie będziemy ___» → G (робити зайвих рухів).",
        "«stół, który ___» → C (має бути елементом декору).",
        "«jest to ___» → E (найважливіший меблевий предмет у домі)."],
)
...
_ZAD4 = MatchTask(
    ...
    explain=[
        "точний список → D (перевір, чи все справді потрібне).",
        "не плати карткою → G (тижневий бюджет, плати готівкою).",
        "більше = дешевше → A (роби запаси товарів тривалого зберігання).",
        "нові технології → F (застосунки Foodsi/Too Good To Go).",
        "продукти на кілька обідів → B (курка: котлети, росіл, ніжки).",
        "старий хліб → E (тости, панірувальні сухарі, суп).",
        "використай рештки → C (додай до супу/омлета)."],
)
